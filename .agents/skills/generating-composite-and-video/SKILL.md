...
- `prompt` = `"@image1 " + veo_prompt` field from `shots.json`
...
| `VIDEO_ASPECT_RATIO` | `"16:9"` | `"16:9"`, `"9:16"`, `"1:1"`, etc. |
...
| Video submit     | POST | `/jobs/createTask` | model: `grok-imagine/image-to-video`, `image_urls`, `aspect_ratio`, `duration`, `resolution` |
